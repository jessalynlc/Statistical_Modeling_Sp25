...
The mean red urchin size in 2015 was not significantly different between the control group (mean ± standard deviation = 8.18 ± 1.38, n = 180) and the annual removal group (mean ± standard deviation = 8.22 ± 0.92, n = 175) as determined by a two-sample, two-sided t-test (t = -0.29, df = 313.51, p = 0.77, α = 0.05)
...
The mean red urchin size in 2016 was significantly different between the control group (mean ± standard deviation = 8.55 ± 1.06, n = 101) and the annual removal group (mean ± standard deviation = 8.01 ± 0.85, n = 100) as determined by a two-sample, two-sided t-test (t = 4.0132, df = 190.99, p = 8.597e-05, α = 0.05)
...
The mean red urchin size was significantly different between the 2015 control group data (mean ± standard deviation = 8.18 ± 1.38, n = 180) and the 2016 control group data (mean ± standard deviation = 8.55 ± 1.06, n = 101) as determined by a two-sample, two-sided t-test (t = -2.54, df = 252.7, p = 0.01, α = 0.05)